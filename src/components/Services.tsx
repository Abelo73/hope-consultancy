  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        {/* Icon container */}
        <div
          className={`flex items-center justify-center w-14 h-14 rounded-2xl mb-7 transition-all duration-500 transform group-hover:scale-110 group-hover:rotate-6 ${
            isPlacement
